...
function predictWeather(){
    ...
    $.getJSON(url + apiKey + "/" + lati + "," + longi + "," + time + "?callback=?", function(data) {
              ...
              currentContent += '<p><span class="label-hilo">High: ' + Math.round(data.daily.data[0].temperatureMax) + '&deg;</span>';
              currentContent += '<span class="label-hilo">&nbsp;&nbsp;Low: ' + Math.round(data.daily.data[0].temperatureMin) + '&deg;</span></p></div>';
