...
function predictWeather(){
    ...
    $.getJSON(url + apiKey + "/" + lati + "," + longi + "," + time + "?callback=?", function(data) {
              ...
              currentContent += '<div class="six columns">';
              currentContent += ' <h1 class="weather-current"><span style="margin-top:-40px"><i class="wi wi-forecast-io-' + data.currently.icon + '"></i></span>' + Math.round(data.currently.temperature) + '&deg;</h1>';
