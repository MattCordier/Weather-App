...
?>  
                ...
                <div class="col-xs-4">
                    <form>
                        <input class="location-search" type="text" name="#"  onfocus="if(this.value == 'Select a Location') { this.value = ''; }" onblur="if(this.value=='') this.value='Select a location';" value="Select a Location">
                    </form>
