...
<html >
    ...
    <body>
        ...
        <?php 
            if (login_check($mysqli) == true) {
                echo '<p class="user-stats">Logged ' . $logged . ' as ' . htmlentities($_SESSION['username']) . '.&nbsp</p>';
                echo '<p class="user-stats">Change user? <a href="includes/logout.php">Log out</a>.&nbsp</p>';
            } else {
